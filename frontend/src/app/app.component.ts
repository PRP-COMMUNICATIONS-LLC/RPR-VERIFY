...
@Component({
  ...
  template: `
    <div style="position: fixed; top: 0; left: 0; right: 0; z-index: 1000; background: #000000;">
      <header style="display: flex; align-items: center; justify-content: space-between; padding: 25px 40px; border-bottom: 1px solid #1a1a1a;">
        ...
        <div style="display: flex; align-items: center; gap: 32px;">
          ...
          @if (projectService.activeProjectId()) {
            <div style="display: flex; flex-direction: column; align-items: flex-end;">
              <span style="font-size: 8px; color: #666666; letter-spacing: 0.2em; text-transform: uppercase;">Active Project</span>
              <span style="font-size: 12px; font-weight: 700; color: #FFFFFF; letter-spacing: 0.1em; font-family: monospace;">
    ...
    <!-- SENTINEL UNHIDE: Ensure router-outlet container allows scrolling -->
    <div style="padding-top: 140px; padding-bottom: 80px; height: auto; min-height: calc(100vh - 140px); overflow-y: auto; overflow-x: hidden;">
...
export class AppComponent {
  ...
  getSentinelColor(): string {
    // Use VerificationService systemColor as primary source
