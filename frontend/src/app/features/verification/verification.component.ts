    ...
    <div style="width: 100%; background-color: transparent; min-height: 100vh;">
      ...
      <div style="padding: 40px;">
        <div style="display: flex; align-items: flex-end; gap: 24px;">
          <svg width="60" height="60" viewBox="0 0 512 512" [attr.fill]="pulseColor()" aria-label="Sovereign Verification Status Icon">
      ...
      <div style="padding: 0 40px 40px; display: grid; grid-template-columns: 7fr 3fr; gap: 40px; align-items: stretch;">
        ...
        <section style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.15); border-radius: 4px; overflow: hidden;">
          ...
          <div style="padding: 40px; display: grid; grid-template-columns: 1fr 1fr; gap: 40px;">
            <div>
              <h4 style="font-size: 10px; color: #FFFFFF; letter-spacing: 0.1em; margin-bottom: 16px; text-transform: uppercase;" aria-label="Sovereign POI Verification Module">I. Identity Section</h4>
            ...
            <div>
              <h4 style="font-size: 10px; color: #FFFFFF; letter-spacing: 0.1em; margin-bottom: 16px; text-transform: uppercase;" aria-label="Sovereign POA Verification Module">II. Address Section</h4>
              <div style="display: flex; flex-direction: column; gap: 8px; font-size: 12px; color: rgba(255,255,255,0.7);">
            ...
            <div>
              <h4 style="font-size: 10px; color: #FFFFFF; letter-spacing: 0.1em; margin-bottom: 16px; text-transform: uppercase;" aria-label="Sovereign Entity Verification Module">III. Entity Section</h4>
              <div style="display: flex; flex-direction: column; gap: 8px; font-size: 12px; color: rgba(255,255,255,0.7);">
            ...
            <div>
              <h4 style="font-size: 10px; color: #FFFFFF; letter-spacing: 0.1em; margin-bottom: 16px; text-transform: uppercase;" aria-label="Sovereign Bank Verification Module">IV. Bank Section</h4>
              <div style="display: flex; flex-direction: column; gap: 8px; font-size: 12px; color: rgba(255,255,255,0.7);">
